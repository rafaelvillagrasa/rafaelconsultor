...
export default function ServiceCard({ service, index }: ServiceCardProps) {
  ...
  return (
    <motion.div
      className="group bg-dark-card rounded-xl p-6 hover:bg-gradient-to-br hover:from-dark-card hover:to-dark-card/50 border border-white/10 hover:border-white/20 transition-all duration-500"
      variants={fadeInUp}
    >
